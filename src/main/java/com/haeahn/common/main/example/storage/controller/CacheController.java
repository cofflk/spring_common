...
import com.haeahn.common.global.storage.cache.local.DynamicCacheManager;
...
import com.haeahn.common.main.example.storage.service.ExampleCacheService;
...
//    @RequestMapping("/test")
    ...
    @RequestMapping("/getStaticCache1/{value}")
    ...
    @RequestMapping("/getStaticCache2/{value}")
    ...
    @RequestMapping("/getDynamicCache/{value}")
