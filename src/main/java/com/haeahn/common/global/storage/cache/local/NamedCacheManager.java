...
@EnableCaching
@Configuration
public class NamedCacheManager {
...
//        2. 특정 캐시에 대해 별도 정책 적용
        cacheManager.registerCustomCache("minuteCache", Caffeine.newBuilder()
                .maximumSize(1000)
                .expireAfterAccess(1, TimeUnit.MINUTES)
                .recordStats()
                .build());

        cacheManager.registerCustomCache("dailyCache", Caffeine.newBuilder()
                .maximumSize(1000)
